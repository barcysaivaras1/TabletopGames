 ...
 */
public class EverdellComponent extends Component {
    public EverdellComponent(CoreConstants.ComponentType type, String name) {
        super(type, name);
    }

    protected EverdellComponent(CoreConstants.ComponentType type, String name, int componentID) {
     ...
     */
    @Override
    public EverdellComponent copy() {
        EverdellComponent copy = new EverdellComponent(type, componentName, componentID);
    ...
    public boolean equals(Object o) {
        ...
        return (o instanceof EverdellComponent) && super.equals(o);
    }
